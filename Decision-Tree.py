...
# Splits the training and testing data 100 times, and for each of those times, trains the decision tree algorithm
# on the training data using the specified attribute split criterion, and tests it on both the training and the 
# testing data. It then computes the accuracy for each run and makes histograms displaying these accuracies
# def make_graphs(split_criterion, use_extra_stop):
    
#     training_run_accuracies = []
#     test_run_accuracies = []

#     for i in range(100):
#         train, test = train_test_split()    
#         training_run_accuracies.append(compute_accuracy(train, train, split_criterion, use_extra_stop))
#         test_run_accuracies.append(compute_accuracy(train, test, split_criterion, use_extra_stop))
    
#     if not use_extra_stop:
#         plt.hist(training_run_accuracies, bins=50)
#         plt.xlabel('Accuracy')
#         plt.ylabel('Accuracy Frequency on Training Data')
#         plt.title('Training Set Accuracies')
#         if split_criterion == 'Information Gain':
#             plt.savefig('Decision-Tree/InfoGain_Plots/training_set_accuracies_histogram_infogain')
#             plt.clf()
#         else:
#             plt.savefig('Decision-Tree/Gini_Plots/training_set_accuracies_histogram_gini')
#             plt.clf()


#         plt.hist(test_run_accuracies, bins=50)
#         plt.xlabel('Accuracy')
#         plt.ylabel('Accuracy Frequency on Testing Data')
#         plt.title('Test Set Accuracies')
#         if split_criterion == 'Information Gain':
#             plt.savefig('Decision-Tree/InfoGain_Plots/test_set_accuracies_histogram_infogain')
#             plt.clf()
#         else:
#             plt.savefig('Decision-Tree/Gini_Plots/test_set_accuracies_histogram_gini')
#             plt.clf()

#         print('Training Set Mean Accuracy (' + split_criterion + '): ' + str(np.mean(training_run_accuracies)))
#         print('Training Set Accuracy Standard Deviation (' + split_criterion + '): ' + str(np.std(training_run_accuracies)))

#         print('Test Set Mean Accuracy (' + split_criterion + '): ' + str(np.mean(test_run_accuracies)))
#         print('Test Set Accuracy Standard Deviation (' + split_criterion + '): ' + str(np.std(test_run_accuracies)))

#     else:
#         plt.hist(training_run_accuracies, bins=50)
#         plt.xlabel('Accuracy')
#         plt.ylabel('Accuracy Frequency on Training Data')
#         plt.title('Training Set Accuracies with 85% Stopping Criteria')
#         plt.savefig('Decision-Tree/Extra_Stop_Plots/training_set_accuracies_histogram_extra_stop')
#         plt.clf()

#         plt.hist(test_run_accuracies, bins=50)
#         plt.xlabel('Accuracy')
#         plt.ylabel('Accuracy Frequency on Testing Data')
#         plt.title('Test Set Accuracies with 85% Stopping Criteria')
#         plt.savefig('Decision-Tree/Extra_Stop_Plots/test_set_accuracies_histogram_extra_stop')
#         plt.clf()

#         print('Training Set Mean Accuracy: ' + str(np.mean(training_run_accuracies)))
#         print('Training Set Accuracy Standard Deviation: ' + str(np.std(training_run_accuracies)))

#         print('Test Set Mean Accuracy: ' + str(np.mean(test_run_accuracies)))
#         print('Test Set Accuracy Standard Deviation: ' + str(np.std(test_run_accuracies)))


# # Creates the graphs according Problem 2
# make_graphs('Information Gain', False)

# # Creates the graphs according Extra Credit Problem 1
# make_graphs('Gini', False)

# # Creates the graphs according Extra Credit Problem 2
# make_graphs('Information Gain', True)
